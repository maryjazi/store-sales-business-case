...
SCHEMAS = {
    ...
    "kpi_promotion_uplift_observational.csv": {
        "phase": 11,
        "format": "csv",
        "columns": {
            "family": "object",
            "promo_days": "int64",
            "promo_days_excluded_insufficient_support": "int64",
            "observed_units_on_promo": "float64",
            "expected_units_observational": "float64",
            "estimated_observational_uplift_pct": "float64",
            "baseline_l1_share_pct": "float64",
            "baseline_l2_share_pct": "float64",
            "baseline_l3_share_pct": "float64",
            "baseline_l4_share_pct": "float64",
            "baseline_l5_share_pct": "float64",
            "median_promotion_breadth": "float64",
        },
    },
    ...
    "diagnostic_promotion_falsification.csv": {
        "phase": 11,
        "format": "csv",
        "columns": {
            "family": "object",
            "real_estimated_uplift_pct": "float64",
            "placebo_estimated_uplift_pct": "float64",
            "placebo_days": "float64",
            "placebo_observed_units": "float64",
            "placebo_expected_units_observational": "float64",
            "cross_family_observed_units_real": "float64",
            "cross_family_expected_units_real": "float64",
            "cross_family_observed_units_placebo": "float64",
            "cross_family_expected_units_placebo": "float64",
            "placebo_calendar_coverage_pct": "float64",
            "cross_family_displacement_real_pct": "float64",
            "cross_family_displacement_placebo_pct": "float64",
            "interpretation_warning": "object",
        },
    },
    "kpi_promotion_economics_sim.csv": {
        "phase": 11,
        "format": "csv",
        "columns": {
            "family": "object",
            "promo_days": "int64",
            "observed_units_on_promo": "float64",
            "baseline_units_observational": "float64",
            "avg_list_price_sim": "float64",
            "avg_promo_price_sim": "float64",
            "avg_unit_cost_sim": "float64",
            "gm_promotion_scenario_sim": "float64",
            "gm_baseline_scenario_sim": "float64",
            "incremental_gross_margin_sim": "float64",
            "markdown_investment_sim": "float64",
            "promo_roi_sim": "float64",
            "list_margin_rate_sim": "float64",
            "discount_depth_pct_sim": "float64",
            "break_even_uplift_pct_sim": "float64",
            "estimated_observational_uplift_pct": "float64",
            "uplift_gap_vs_break_even_pct_points": "float64",
        },
    },
    "kpi_commercial_scenarios_sim.csv": {
        "phase": 12,
        "format": "csv",
        "columns": {
            "scenario": "object",
            "scenario_description": "object",
            "family": "object",
            "elasticity_assumption": "float64",
            "price_change_pct": "float64",
            "demand_units_sim": "float64",
            "fulfilled_units_sim": "float64",
            "net_price_sim": "float64",
            "unit_cost_sim": "float64",
            "revenue_sim": "float64",
            "cogs_sim": "float64",
            "gross_margin_sim": "float64",
            "markdown_value_sim": "float64",
            "procurement_spend_sim": "float64",
            "avg_inventory_value_sim": "float64",
            "demand_fulfillment_rate_pct_sim": "float64",
            "simulated_oos_day_rate_pct": "float64",
        },
    },
    "kpi_scenario_summary_sim.csv": {
        "phase": 12,
        "format": "csv",
        "columns": {
            "scenario": "object",
            ...
            "gross_margin_pct_sim": "float64",
            "demand_fulfillment_rate_pct_sim": "float64",
            "oos_day_rate_pct_sim": "float64",
            "families_touched": "int64",
            "revenue_change_vs_baseline_pct": "float64",
            "gross_margin_change_vs_baseline_pct": "float64",
            "markdown_value_change_vs_baseline_pct": "float64",
            "procurement_spend_change_vs_baseline_pct": "float64",
            "avg_inventory_value_change_vs_baseline_pct": "float64",
        },
    },
    # ---- phase 13: the BI model behind the commercial cockpit (dashboard/commercial/) ----
    "fact_commercial_monthly.parquet": {
        "phase": 13,
        "format": "parquet",
        "columns": {
            "month": "datetime64[ns]",
            ...
            "cogs_sim": "float64",
            "gross_margin_sim": "float64",
            "avg_inventory_units_sim": "float64",
            "avg_inventory_value_sim": "float64",
            "stockout_days_sim": "int32",
            "promo_days": "int32",
        },
    },
    "fact_procurement_monthly.parquet": {
        "phase": 13,
        "format": "parquet",
        "columns": {
            "month": "datetime64[ns]",
            ...
            "supplier_id": "object",
            "po_lines": "int32",
            "ordered_qty_sim": "float64",
            "received_qty_sim": "float64",
            "po_value_sim": "float64",
            "ppv_total_sim": "float64",
            "on_time_lines_sim": "int32",
            "in_full_lines_sim": "int32",
            "avg_lead_time_days_sim": "float64",
        },
    },
    "dim_family_commercial.csv": {
        "phase": 13,
        "format": "csv",
        "columns": {
            "family": "object",
    ...
    "dim_supplier_commercial.csv": {
        ...
        "columns": {
            ...
            "price_factor": "float64",
            "order_multiple": "int64",
            "families_primary": "float64",
        },
    },
    # P-06 as data: every measure on the cockpit declares what it rests on.
    "dim_measure_provenance.csv": {
        "phase": 13,
        "format": "csv",
        "columns": {
            "measure": "object",
            "provenance_tier": "object",
            "source_phase": "int64",
            "note": "object",
        },
    },
