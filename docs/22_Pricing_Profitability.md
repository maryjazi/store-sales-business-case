...
The reconciliation is asserted in the script (which aborts on a mismatch) and again in
`tests/test_pricing_layer.py`. Note that it only holds in float64: `observed_units` had to be
